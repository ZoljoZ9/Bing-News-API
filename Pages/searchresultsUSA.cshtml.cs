...
{
    public class searchResultsUSA : PageModel
    {
        private readonly ILogger<searchResultsUSA> _logger;
        ...
        public searchResultsUSA(ILogger<searchResultsUSA> logger, UserDbContext dbContext)
        {
            _logger = logger;
        ...
        public async Task OnGetAsync(int pageNumber = 1)
        {
            ...
            try
            {
                ...
                string apiUrl = $"https://api.bing.microsoft.com/v7.0/news/search?q=top+news&count=20&offset={(PageNumber - 1) * pageSize}&mkt=en-US";
